...
set logfile logs/rtl2final.lec.log
...
read_implementation_information fv/scr1_pipe_top -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../riscvCoreSyntaCore1/src/includes/scr1_ahb.svh ../riscvCoreSyntaCore1/src/includes/scr1_arch_types.svh ../riscvCoreSyntaCore1/src/includes/scr1_csr.svh ../riscvCoreSyntaCore1/src/includes/scr1_riscv_isa_decoding.svh ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_exu.sv ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_ialu.sv ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_idu.sv ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_ifu.sv ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_lsu.sv ../riscvCoreSyntaCore1/src/core/pipeline/scr1_pipe_top.sv
elaborate_design -golden -root {scr1_pipe_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/scr1_pipe_top/fv_map.v.gz
elaborate_design -revised -root {scr1_pipe_top}

uniquify -all -nolib -golden

read_power_intent -insert_isolation -1801 -golden ../scripts/genus/block.upf
read_power_intent -1801 -revised fv/scr1_pipe_top/fv_map.upf
...
#add_name_alias fv/scr1_pipe_top/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
