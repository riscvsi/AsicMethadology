...
#  Generated on:      Fri Feb  3 11:23:24 2023
...
set_db port:wb_clk_i .cts_is_sdc_clock_root true

# Clocks present at pin wb_clk_i
#   clk (period 8.000ns) in timing_config functional_func_slow_max([/dev/null])
create_clock_tree -name clk -source wb_clk_i -no_skew_group
# Clock period setting for source pin of clk
set_db port:wb_clk_i .cts_clock_period 8
...
create_skew_group -name clk/functional_func_slow_max -sources wb_clk_i -auto_sinks
